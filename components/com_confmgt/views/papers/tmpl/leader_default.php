...
$filterurl = 'components/com_confmgt/assets/js/table_filter.js';
$document->addScript($bootboxurl);
$document->addScript($delurl);
$document->addScript($filterurl);
...
<div class="panel panel-default">
    ...
    <table class="table table-striped" id="papers-table">
        ...
        foreach ($this->leaders_items as $item) : ?>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo JRoute::_('mailto:' . $item->email); ?>">
                ...
                <td>
                    <a href="<?php echo JRoute::_('index.php?option=com_confmgt&view=rev1ewersforpaperform&linkid=' . (int)$item->id); ?>">
                        <?php echo $item->rev1ewers; ?>
                    </a>
                </td>
                <td>
                    <?php if ($item->abstract_review_outcome == 0) { ?><a
                        href="<?php echo JRoute::_('index.php?option=com_confmgt&view=abrev1ewoutcomeform&linkid=' . (int)$item->id); ?>">
                ...
                <td>
                    <?php if (empty($item->fullpaper_id)) {
                        ...
                        <a href="<?php echo JRoute::_('index.php?option=com_confmgt&view=fullrev1ewoutcomeform&linkid=' . (int)$item->id); ?>">
                            <?php echo JText::_("No"); ?></a>
                    <?php } else { ?> <a
                        href="<?php echo JRoute::_('index.php?option=com_confmgt&view=fullrev1ewoutcomeform&linkid=' . (int)$item->id); ?>"><?php echo JText::_("Yes"); ?></a>
                    <?php } ?>
                </td>
            </tr>
        <?php endforeach; ?>
    ...
    <div class="panel-footer">
        <div class="inline">
            <form id="form-entrypage" action="<?php echo JRoute::_('index.php'); ?>" method="post"
        ...
        <div class="inline">
            <form id="form-reviewers-list" action="<?php echo JRoute::_('index.php'); ?>" method="post"
                  class="form-validate form-entry" enctype="multipart/form-data">
                <?php echo JHtml::_('form.token'); ?>
                <button class="btn btn-default btn-lg" type="submit">
                    <i class="icon-list"></i>
