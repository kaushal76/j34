    ...
    <div class="paper-edit front-end-edit">
      ...
      <form id="form-paper" role="form" action="<?php echo JRoute::_('index.php?option=com_confmgt&task=paperform.save'); ?> 
        ...
        <div class="control-group">
          ...
          <div class="controls"> <?php echo nl2br($this->
				item->abstract); ?> </div>
        </div>
        <div class="control-group">
          <div class="control-label"> <?php echo $this->
        ...
        <div class="control-group">
         ...
         <div class="control-group">
          ...
          <div class="controls"> <?php echo $this->item->student_submission; ?> </div>
        </div>
        <div class="control-group">
          <div class="control-label"> <?php echo $this->
        ...
        <div class="control-group">
          <div class="form-actions">
            ...
            <input type="hidden" name="jform[student_submission]" value="<?php echo $this->item->student_submission; ?>"/>
