...
<div class="panel panel-default">
    <div class="panel-heading">
        <h1>
            <?php
            echo JText::_('Full paper details') . ' - ' . JText::_('Paper ID ') . $this->paper->id; ?>
        </h1>
    </div>
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td><?php
                echo nl2br($this->paper->full_paper); ?></td>
        </tr>
        <tr>
            <td class="header"><?php
                echo JText::_('Full paper download'); ?>
                :
            </td>
            <td><?php
                echo $this->paper->full_paper_download; ?></td>
        </tr>
    </table>
</div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo JText::_('Full paper review'); ?></h3>
    </div>
        ...
        <div class='form-horizontal'>
            <fieldset>
                <div class="review-edit front-end-edit">
                    ...
                    <?php endif; ?>
                    <form id="form-review" role="form" action="<?php echo JRoute::_('index.php'); ?>" method="post"
