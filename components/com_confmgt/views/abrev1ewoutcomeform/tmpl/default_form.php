...
<div class='form-horizontal well'>
    <fieldset>
        <div class="reviewoutcome-edit front-end-edit">
                <legend><?php echo JText::_('Post abstract review results to the author'); ?></legend>
                ...
                <div class="control-group">
                    <div class="form-actions">
                        ...
                        <?php echo JText::_('or'); ?> <a
                            href="<?php echo JRoute::_('index.php?option=com_confmgt&task=abrev1ewoutcomeform.cancel'); ?>"
