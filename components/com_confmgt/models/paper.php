...
class ConfmgtModelPaper extends JModelItem
{
    ...
    private function _getQuery()
    {
        ...
        $query
            ...
            ->select($db->quoteName('c.checked_out_by', 'abstract_checked_out_by'))
            ...
            ->select($db->quoteName('d.cover_page', 'presentation_cover_page'))
            ...
            ->select($db->quoteName('e.cover_page', 'camera_cover_page'))
