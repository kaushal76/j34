...
/**
 * Model class for Presentation form
 * @package     CONFMGT
 *
 * @since version 3.8.0
 */
class ConfmgtModelPresentationForm extends JModelForm
{
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_confmgt.presentation', 'presentationform', array(
            'control' => 'jform',
            'load_data' => $loadData
        ));
        if (empty($form)) {
    ...
    public function save($data)
    {
        ...
        if ($table->save($data) === true) {
            ...
            $paperdata = array();
            $paperdata['id'] = $linkid;
            $paperdata['presentation'] = $table->presentation;
            $paperdata['presentation_id'] = $table->id;
