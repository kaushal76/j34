...
/**
 * Camera ready paper form controller class
 * @package     CONFMGT
 *
 * @since version 3.8.0
 */
class ConfmgtControllerCameraReadyPaperForm extends ConfmgtController
{
    ...
    public function save()
    {
        ...
        $data['camera_ready'] = $files['camera_ready']['name'];
        ...
        if ($data === false) {
            ...
            $app->setUserState('com_confmgt.edit.camerareadypaper.data', JFactory::getApplication()->input->get('jform', array(), 'array'));

            // Redirect back to the edit screen.
            $id = (int)$app->getUserState('com_confmgt.edit.camerareadypaper.id');

            $this->setRedirect(JRoute::_('index.php?option=com_confmgt&view=camerareadypaperform&layout=edit&linkid=' . $linkid . '&id=' . $id, false));
            return false;
        }
        ...
        $app->setUserState('com_confmgt.edit.camerareadypaper.linkid', null);
