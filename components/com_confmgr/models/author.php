...
/**
 * Item Model for author.
 *
 * @package     Confmgr
 * @subpackage  Models
 */
class ConfmgrModelAuthor extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_confmgr.author';
	 ...
	 */
	public function getTable($type = 'Author', $prefix = 'ConfmgrTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('author.id');
