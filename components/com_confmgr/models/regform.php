...
/**
 * Item Model for Regform.
 *
 * @package     Confmgr
 * @subpackage  Models
*/
class ConfmgrModelRegform extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_confmgr.regform';
	 ...
	 */
	public function getTable($type = 'Regform', $prefix = 'ConfmgrTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('regform.id');
	...
	
	{
		...
		{ // bind the data and if it fails raise an error
