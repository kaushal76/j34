...
/**
 * Item Model for author_for_paper.
 *
 * @package     Confmgr
 * @subpackage  Models
 */
class ConfmgrModelAuthor_for_paper extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_confmgr.author_for_paper';
	 ...
	 */
	public function getTable($type = 'Author_for_paper', $prefix = 'ConfmgrTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('author_for_paper.id');
