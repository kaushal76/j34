...
/**
 * JDeveloper Library Model
 *
 * @package     JDeveloper
 * @subpackage  Models
 */
class JDeveloperModelLibrary extends JDeveloperModelExtension
{	
	/**
	 ...
	 * @throws  Exception
	 */
	public function getTable($type = 'Library', $prefix = 'JDeveloperTable', $config = array())
	{
	...
	public function getItem($pk = null)
	{
		...
		if ($table->load(array("tag" => "config", "relation" => "library." . $item->id . ".config"), true)) {
	...
	public function getLastItemId() {
		...
		->select("a.id")
		->from("#__jdeveloper_libraries AS a")
