...
/**
 * Item Model for full_paper.
 *
 * @package     Confmgr
 * @subpackage  Models
 */
class ConfmgrModelFull_paper extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_confmgr.full_paper';
	 ...
	 */
	public function getTable($type = 'Full_paper', $prefix = 'ConfmgrTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('full_paper.id');
