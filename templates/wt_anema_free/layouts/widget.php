...
// Set default panel
if ($panel == '' && in_array($widget->position, array('heading', 'top-a', 'top-b', 'top-c', 'top-d', 'bottom-a', 'bottom-b', 'bottom-c', 'bottom-d', 'footer-bottom', 'main-top', 'main-bottom', 'sidebar-a', 'sidebar-b'))) {
...
// Set title
if (in_array($widget->position, array('headerbar', 'toolbar-r' ,'toolbar-l', 'footer-r', 'footer-l'))) {
    $title = '';
